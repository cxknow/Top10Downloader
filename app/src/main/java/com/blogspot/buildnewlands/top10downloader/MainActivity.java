package com.blogspot.buildnewlands.top10downloader;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String mFileContents; //download result
    ...
    private class DownloadData extends AsyncTask<String, Void, String>{
        ...
        private String downloadXMLFile(String urlPath){
            ...
            try {
                ...
                Log.d("DownloadData","SecurityException, needs permission? " + e.getMessage());
            }
            return null;
        }
    }
